...
_error_tipo dd 0
str_0 db " @2", 13, 10, "    === INICIO TEST ZOOLOGICO === @3", 13, 10, "    Temas: 2,5,8,9,14,19,21,23,25,28,31,32 @4", 13, 10, "    Checks Runtime: b, e, f @5", 13, 10, "    ", 0
...
str_66 db "=== FIN TEST ZOOLOGICO ===", 0
.code
start:
Label0:
